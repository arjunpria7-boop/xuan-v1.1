  ...
  return (
    <div className="w-full bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex flex-col items-center gap-4 animate-fade-in backdrop-blur-sm">
      ...
      <button
        ...
        className="w-full max-w-xs mt-2 bg-gradient-to-br from-blue-500 to-purple-600 text-white font-bold py-4 px-6 rounded-lg transition-all duration-300 ease-in-out shadow-lg shadow-blue-500/20 hover:shadow-xl hover:shadow-blue-500/40 hover:-translate-y-px active:scale-95 active:shadow-inner text-base disabled:from-blue-800 disabled:to-purple-800 disabled:shadow-none disabled:cursor-not-allowed disabled:transform-none"
      >
        Terapkan Potongan
      </button>
    </div>
